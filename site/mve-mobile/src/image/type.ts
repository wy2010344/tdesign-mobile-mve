...
export type ImageProps = {
   ...
   * @default fill
   */
  fit?: ValueOrGet<Property.ObjectFit>;
  /**
   * 是否开启图片懒加载
   * @default false
   */
   ...
   * @default center
   */
  position?: ValueOrGet<Property.ObjectPosition>;
  /**
   * `<img>` 标签的原生属性，[MDN 定义](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Referrer-Policy)
   */
  referrerpolicy?: ValueOrGet<React.LinkHTMLAttributes['referrerPolicy']>;
  /**
   * 图片圆角类型
   * @default square
   */
  shape?: ValueOrGet<'circle' | 'round' | 'square'>;
  /**
   * 图片链接
   * @default ''
   */
